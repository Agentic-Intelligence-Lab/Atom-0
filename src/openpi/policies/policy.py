...
class Policy(BasePolicy):
    def __init__(
        ...
        *,
        ...
        # Long-term memory state is owned by the high-level policy server (HLInferenceServer),
        # not by the action policy. This Policy only samples actions from the (optional) subtask.

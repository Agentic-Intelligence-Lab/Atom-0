...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotHLDataConfig(
            # RMBench observe_and_pickup converted to LeRobot (set LEROBOT_HOME=/path/to/lerobot).
            repo_id="wudi/observe_and_pickup",

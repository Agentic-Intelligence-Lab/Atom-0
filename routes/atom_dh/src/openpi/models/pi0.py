...
class Pi0(_model.BaseModel):
    ...
    def compute_loss(
        ...
        # Eval/inference call compute_loss(train=False) and only consume flow.
        # Keep OT out of that graph so val does not all-gather / Soft-DTW.
        if train and getattr(self, "ot_enabled", False):

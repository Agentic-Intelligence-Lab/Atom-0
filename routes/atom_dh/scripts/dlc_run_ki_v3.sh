...
#   PROJECT_DIR=/path/to/Atom-0
#   CACHE_DIR=/mnt/data/cache
#   NORM_STATS_SRC=/path/to/Atom-0/assets/pi05_libero/physical-intelligence/libero/norm_stats.json
...
NORM_STATS_SRC="${NORM_STATS_SRC:-/path/to/Atom-0/assets/pi05_libero/physical-intelligence/libero/norm_stats.json}"
...
Environment:
  PROJECT_DIR                 Repo path. Default: /path/to/Atom-0

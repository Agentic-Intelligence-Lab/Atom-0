...
export OPENPI_MODEL_HOME="${OPENPI_MODEL_HOME:-${ATOM0_STATE_ROOT}/models/openpi}"
export RLDS_DATA_DIR="${RLDS_DATA_DIR:-${ATOM_RLDS_ROOT:-${ATOM0_STATE_ROOT}/datasets/RLDS}}"

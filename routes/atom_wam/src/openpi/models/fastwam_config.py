    ...
    def inputs_spec(self, *, batch_size: int = 1) -> tuple[_model.Observation, _model.Actions]:
        ...
        with at.disable_typechecking():
            observation_spec = _model.Observation(
                ...
                # State can still support external relative-action conversion without
                # conditioning the WAM. None disables its learned proprio encoder.
                state=jax.ShapeDtypeStruct([batch_size, self.proprio_dim or self.action_dim], jnp.float32),

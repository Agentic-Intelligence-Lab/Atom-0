...
export REALWORLD_PIPER30_BUILDER_DIR=/path/to/rlds/realworld_piper_task_split/piper_s14_a14_fps30_c4_ee_pose_cam_front_cam_high_cam_left_wrist_cam_right_wrist/realworld_piper_infidata/1.1.0
export REALWORLD_PIPER30_TRAIN_EPISODES=4927
export REALWORLD_PIPER_2_BUILDER_DIR=/path/to/rlds/realworld_piper_2/realworld_piper_infidata/1.0.0
...
uv run --group rlds python scripts/compute_cotrain_full_norm_stats_light.py \
  ...
  --output-assets-dir /path/to/Atom-0/assets/cotrain_real_only \
...
uv run --group rlds python scripts/compute_cotrain_full_norm_stats_light.py \
  ...
  --output-assets-dir /path/to/Atom-0/assets/cotrain_real_robot \
  --num-parallel-reads 1 \
  --num-parallel-calls 2 \
  --overwrite
```
...
```bash
mkdir -p \
  /path/to/Atom-0/assets/cotrain_real_only/piper30 \
  /path/to/Atom-0/assets/cotrain_real_only/piper2

cp -a /path/to/Atom-0/assets/cotrain_real_robot/piper30/. \
  /path/to/Atom-0/assets/cotrain_real_only/piper30/
cp -a /path/to/Atom-0/assets/cotrain_real_robot/piper2/. \
  /path/to/Atom-0/assets/cotrain_real_only/piper2/
```
...
```bash
UV_CACHE_DIR=/path/to/cache/uv uv run python - <<'PY'

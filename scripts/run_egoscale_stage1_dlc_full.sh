...
export CHECKPOINT_BASE_DIR="${CHECKPOINT_BASE_DIR:-/mnt/workspace/junhe/checkpoints}"
export JAX_COMPILATION_CACHE_DIR="${JAX_COMPILATION_CACHE_DIR:-/mnt/workspace/junhe/cache/jax}"

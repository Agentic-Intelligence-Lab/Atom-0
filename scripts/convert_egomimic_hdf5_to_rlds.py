...
Examples:
    ...
    python scripts/convert_egomimic_hdf5_to_rlds.py \
      --source-hdf5 /path/to/atom-workspace/datasets/EgoMimic/groceries_human.hdf5 \
      --output-data-dir /path/to/atom-workspace/RLDS/EgoMimic_smoke \
      --max-train-episodes 2 --max-validation-episodes 1

    python scripts/convert_egomimic_hdf5_to_rlds.py \
      --source-hdf5 /path/to/atom-workspace/datasets/EgoMimic/groceries_robot.hdf5 \
      --output-data-dir /path/to/atom-workspace/RLDS/EgoMimic_smoke \
      --max-train-episodes 2 --max-validation-episodes 1
